...
document/range formatting, rename, and bounded
...
- automatic external reload/merge, general cross-file workspace resource
  ...
  workspace;
- LSP symbols, semantic tokens, user-authored server configuration, workspace
  folders, code-action command execution, and a language-server trust/sandbox
  model;
